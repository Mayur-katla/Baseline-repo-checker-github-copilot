...
const ScanPage = () => {
  ...
  return (
    <motion.div 
      ...
      className="min-h-screen w-full px-4 py-8 bg-gray-900 text-white"
    >
        ...
        <div className="mt-12 bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50">
          ...
          <ol className="relative border-l border-gray-700">
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-indigo-900 rounded-full -left-3 ring-8 ring-indigo-900/20">
                <span className="text-indigo-300 font-bold">1</span>
              </span>
              <h4 className="font-semibold text-white">Configure Repository</h4>
              <p className="text-sm text-gray-400">Choose your repository source (GitHub, local, or Git URL) and select target browsers.</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-indigo-900 rounded-full -left-3 ring-8 ring-indigo-900/20">
              ...
              <p className="text-sm text-gray-400">Our engine scans your codebase, detecting JavaScript and CSS features.</p>
            </li>
            <li className="mb-10 ml-6">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-indigo-900 rounded-full -left-3 ring-8 ring-indigo-900/20">
                <span className="text-indigo-300 font-bold">3</span>
              </span>
              <h4 className="font-semibold text-white">Compatibility Check</h4>
              <p className="text-sm text-gray-400">We map detected features against Baseline data for your selected browsers.</p>
            </li>
            <li className="ml-6">
              <span className="absolute flex items-center justify-center w-6 h-6 bg-indigo-900 rounded-full -left-3 ring-8 ring-indigo-900/20">
              ...
              <p className="text-sm text-gray-400">Receive a detailed report with actionable modernization suggestions.</p>
            </li>
          </ol>
        </div>
      </div>
