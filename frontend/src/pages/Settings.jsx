...
const SettingsInput = ({ label, type = 'text', value, onChange, helperText, placeholder }) => (
  <div>
    ...
    <input
      ...
      className="w-full px-4 py-2 rounded-lg bg-gray-800/50 border-2 border-gray-700/50 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300 shadow-sm text-white"
    />
